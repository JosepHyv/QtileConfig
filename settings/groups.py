...
keys.extend([
    Key([MOD], 'Right', lazy.screen.next_group(), desc='cambiando al siguiente grupo a la derecha'),
    Key([MOD], 'Left', lazy.screen.prev_group(), desc='cambiando al  grupo anterior a la izquierda'),
 ])

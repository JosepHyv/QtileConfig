...
keys = [
    ...
    ## capturar pantalla 
     ...
     Key([MOD], "m", lazy.spawn('min --force-device-scale-factor=0.85')),
     Key([MOD], 'e', lazy.spawn('thunar')),
     Key([MOD], 't', lazy.spawn('com.todoist.Todoist')), 
     Key([MOD], 's', lazy.spawn('slack')),  
     Key([MOD], 'g', lazy.spawn('google-chrome-stable --force-device-scale-factor=0.82')),  
     Key([MOD], "x", lazy.spawn('chromium --force-device-scale-factor=0.82')),
